...
- dev.rating.event - Used to create rating summary in rating_summary table and lookup for the specific course ID and specific User ID 
  in ratings_lookup table
