...
public class Constants {
	...
	public static final String EMAIL_EXIST_ERROR = "This Email Id already registered with another User.";
	...
	public static final String PHONE_NUMBER_EXIST_ERROR = "This Phone number is already registered with another User.";
