...
public class Constants {
    ...
    public static final List<String> MINIMUL_FIELDS = Collections.unmodifiableList(Arrays.asList("identifier", "duration", "downloadUrl", "description", "mimeType",
    ...
    public static final List<String> DECRYPTED_FIELDS = Collections.unmodifiableList(Arrays.asList("phone", "email"));
