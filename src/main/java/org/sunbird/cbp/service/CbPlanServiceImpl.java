...
public class CbPlanServiceImpl implements CbPlanService {
    ...
    @Autowired
    public CbPlanServiceImpl(AccessTokenValidator accessTokenValidator, CassandraOperation cassandraOperation, UserUtilityService userUtilityService, ContentService contentService, CbExtServerProperties serverProperties, Producer kafkaProducer, CbExtServerProperties cbExtServerProperties) {
