...
@EnableCassandraRepositories(basePackages = {"org.sunbird.progress.cassandraRepo", "org.sunbird.assessment.repo", "org.sunbird.workallocation.repo"}, cassandraTemplateRef = "sunbirdTemplate")
public class SunbirdConfig extends CassandraConfig {
    ...
    public CassandraSessionFactoryBean session() {
        ...
        logger.info(String.format("Cassandra session created for  %s keyspace with IP :  %s", getKeyspaceName(), getContactPoints()));
        return session;
    }
}