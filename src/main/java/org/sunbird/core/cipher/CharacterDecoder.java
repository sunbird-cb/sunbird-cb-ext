...
public abstract class CharacterDecoder {
	 ...
	 * correction codes in a line, they are generally processed by this method. The
	 * simplest version of this method looks for the (newline) character.
	 */
	protected void decodeLineSuffix(PushbackInputStream aStream, OutputStream bStream) throws IOException {
	}

	/**
	 * This method does an actual decode. It takes the decoded bytes and writes them
	 * to the OutputStream. The integer <i>l</i> tells the method how many bytes are
	 * required. This is always <= bytesPerAtom().
	 */
	...
	/**
	 * Alternate decode interface that takes a String containing the encoded buffer
	 * and returns a byte array containing the data.
	 *
	 * @exception IOException An error has occurred while decoding
	 */
