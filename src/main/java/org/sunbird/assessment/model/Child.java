...
public class Child extends JdkSerializationRedisSerializer implements Serializable{
	...
	private List<SubChild> children = null;
	@JsonProperty("name")
	private String name;
	 ...
	 * @param maxQuestions
	 */
	public Child(String parent, List<SubChild> children, String name, String identifier, String description,
