...
public class QuestionSet1 extends JdkSerializationRedisSerializer implements Serializable {
     ...
     * @param status
     */
    public QuestionSet1(List<Section> children, String name, String identifier, String primaryCategory, String versionKey, String mimeType, String code, Long version, String objectType, String status, List<String> childNodes) {
        super();
    ...
    public String toString() {
        ...
        sb.append(QuestionSet1.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("children");
        sb.append('=');
