...
public class AssessmentConsumer {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(AssessmentConsumer.class);
	...
	@KafkaListener(topics = "${kafka.topics.assessment.submit.event}",groupId = "${kafka.topics.assessment.submit.event.consumer.group}" )
