...
public class CassandraOperationImpl implements CassandraOperation{
	...
	public SBApiResponse insertRecord(String keyspaceName, String tableName, Map<String, Object> request) {
		...
		try {
		      ...
		      response.put(Constants.RESPONSE, Constants.SUCCESS);
		        ...
		        logger.error(
		            "Exception occurred while inserting record to " + tableName + " : " + e,
		            e);
		      logger.error(
		          "Exception occured while inserting record to " + tableName + " : " + e,
		          e);
		    }
		return response;
	}
	...
	public Map<String, Object> updateRecord(String keyspaceName, String tableName,
			Map<String, Object> updateAttributes, Map<String, Object> compositeKey) {
