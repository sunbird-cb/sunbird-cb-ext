...
@PrimaryKeyClass
public class BudgetDocInfoPrimaryKeyModel {
    ...
    public BudgetDocInfoPrimaryKeyModel() {
    }

    public BudgetDocInfoPrimaryKeyModel(String orgId, String id, String budgetYear) {
        this.orgId = orgId;
        this.id = id;
